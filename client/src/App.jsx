            ...
            <div className="card-services">
              <div className="card-services__wrapper">
                ...
                <div className="card-services__desctription">
                  Процедура, которая позволяет нам <br /> обследовать и
                  визуализировать внутренние <br /> органы и полости вашего
                  питомца.
                </div>
              ...
              <div className="card-services__wrapper">
                ...
                <div className="card-services__desctription">
                  ...
                  <br />
                  органов, определить наличие патологий, оценить структуру
                  тканей, обнаружить опухоли или аномалии.
                </div>
                <div className="card-services__more more">
                  <a className="more__text-link" href="">
                    ПОДРОБНЕЕ
              ...
              <div className="card-services__wrapper">
                ...
                <div className="card-services__desctription">
                  ...
                  животных, и они работают в тесном сотрудничестве с
                  владельцами, чтобы обеспечить оптимальные условия и уход для
                  малышей.
                </div>
                <div className="card-services__more more">
                  <a className="more__text-link" href="">
              ...
              <div className="love-animal__wrapper">
                <div className="love-animal__main-title main-title">
                  <div className="love-animal__button buttons-category">
                    <button className="buttons-category__about-us">
                      О нас
                    </button>
                  </div>
                  ...
                  <div className="about-us-circle__wrapper">
                    <div className="advantages-pharmacy advantages">
                      ...
                      <div className="advantages-text">
                        Наша аптека специализируется на
                        <br />
                        предоставлении широкого выбора качественных
                        <br />и безопасных медикаментов, диетического
                        <br />
                        питания, витаминов и других средств,
                        <br />
                        необходимых для лечения и поддержания
                        <br />
                    ...
                    <div className="grooming-and-clinic-container">
                      <div className="advantages-grooming advantages">
                        ...
                        <div className="advantages-text">
                          Наши грумеры имеют большой опыт работы со
                          <br />
                          всеми породами собак и кошек и обладают
                          <br />
                          глубокими знаниями о требованиях каждой
                          <br />
                      ...
                      <div className="advantages-clinic advantages">
                        ...
                        <div className="advantages-text">
                          Мы гордимся представить вам самые передовые технологии
                          и оборудование, которые позволяют
                          <br />
                          нам обеспечивать высококачественную
                          <br />
                          диагностику и лечение ваших дорогих питомцев,
                          <br />а также аппарат ингаляционного наркоза для
                ...
                <div className="advantages-cards">
                  <div className="advantages-cards__wrapper">
                    ...
                    <div className="advantages-cards__desctription">
                      Это позволяет нам предоставлять комплексный уход и лечение
                      вашим питомцам на разных этапах их
                      <br />
                      жизни.
                    </div>
                  ...
                  <div className="advantages-cards__wrapper">
                    ...
                    <div className="advantages-cards__desctription">
                      ...
                      <br />
                      совершенствуется, чтобы
                      <br />
                      предоставлять высококачественную и комплексную медицинскую
                      <br />
                      помощь вашим питомцам.
                    </div>
                    <div className="advantages-cards__more more">
                      <a className="more__text-link" href="">
                        ПОДРОБНЕЕ
                  ...
                  <div className="advantages-cards__wrapper">
                    ...
                    <div className="advantages-cards__desctription">
                      Мы всегда слушаем владельцев и стараемся понять все
                      особенности и потребности питомца, чтобы предоставить
                      наиболее эффективное и заботливое лечение.
                    </div>
                    <div className="advantages-cards__more more">
                      <a className="more__text-link" href="">
                        ПОДРОБНЕЕ
                  ...
                  <div className="advantages-cards__wrapper">
                    ...
                    <div className="advantages-cards__desctription">
                      Мы обладаем самым современным оборудованием для
                      диагностики и лечения, что позволяет нам
                      <br />
                      проводить точные и надежные исследования, а также
                      применять передовые методы лечения.
                    </div>
                    <div className="advantages-cards__more more">
                      <a className="more__text-link" href="">
                        ПОДРОБНЕЕ
                ...
                <div className="specialists-cards">
                  <div className="specialists-cards__wrapper">
                    ...
                    <div className="specialists-cards__info">
                      ...
                      <div className="specialists-cards__desctription">
                        Главный ветеринарный врач Центра, репродуктолог-
                        <br />
                        неонатолог, специалист ультразвуковой диагностики
                      </div>
                    </div>
                  </div>
                  <div className="specialists-cards__wrapper">
                  ...
                  <div className="specialists-cards__wrapper">
                    ...
                    <div className="specialists-cards__info">
                      ...
                      <div className="specialists-cards__desctription">
                        Ветеринарный врач-кардиолог, хирург, ортопед,
                        <br />
                        специалист ультразвуковой диагностики, генеральный
                        <br />
                        директор
                      </div>
                    </div>
              ...
              <div className="your-trust__wrapper">
                <div className="your-trust__main-title main-title">
                  <div className="your-trust__button buttons-category">
                    <button className="buttons-category__reviews">
                      Отзывы
                    </button>
                  </div>
                  <div className="your-trust__title body-titles">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;наша{" "}
                    <span className="title-span">гордость</span>
                  </div>
                </div>
              ...
              <div className="record__wrapper">
                <div className="record__main-title main-title">
                  <div className="record__button buttons-category">
                    <button className="buttons-category__enroll">
                      Записаться
                    </button>
                  </div>
              ...
              <div className="map-contacts__wrapper">
                <div className="map-contacts__main-title main-title">
                  <div className="map-contacts__button buttons-category">
                    <button className="buttons-category__contacts">
                      Контакты
                    </button>
                  </div>
