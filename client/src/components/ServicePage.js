        ...
        <tbody>
            ...
            <tr key={index}>
                ...
                (
                    ...
                    <td>{services[2][index] ? `${services[2][index]} руб` : null}</td>
                    )
                    }
    ...
    function  RenderBlock() {
        ...
        if (about == "Травматология и ортопедия"){
            return(
                ...
                <div className='CenterBlock'>
                        <p>
                        Ортопедия – раздел ветеринарной медицины, изучающий профилактику, диагностику и лечение деформаций и нарушений  костно-мышечной системы, которые являются результатом последствий травм, врожденных дефектов и заболеваний. Ортопедия теснейшим образом связанна с травматологией, а также с реабилитацией. </p>
                        <p>
                        В нашем Центре проводится широкий спектр ортопедических обследований и операций, начиная с осмотра ветеринарного ортопеда и заканчивая сложными операциями на позвоночнике.
                        </p>
                    </div>
                    {/* <div className='CenterBlock CenterFill'>
                        <p>В нашем Центре проводится интенсивная терапия новорожденных животных, имеющих проблемы с нормальным материнским вскармливанием. </p>
