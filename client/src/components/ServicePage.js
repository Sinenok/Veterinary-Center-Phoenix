...
const PriceTable = ({ services }) => {
  ...
  const ServicePage = ({about}) => {
    ...
    function  RenderBlock() {
        ...
        if (about == "Репродукция"){
            return(
                <>
                <div className='CenterBlock'>
                        <p>
                        Ветеринарный Центр «Феникс» специализируется на репродуктологии и неонатологии много лет! 
                        </p>
                        <p>За время существования нашего Центра специалисты нашего Центра вылечили множество заболеваний в сфере репродукции и помогли обрести счастье материнства большому количеству животных! </p>
                    </div>
                    {/* <div className='CenterBlock CenterFill'>
                        <p>В нашем Центре проводится интенсивная терапия новорожденных животных, имеющих проблемы с нормальным материнским вскармливанием. </p>
                        <p>Ответ очевиден: нечасто.</p>
                    ...
                    <div className='CenterBlock'>
                        <p>
                        Кроме того, специалисты нашего Центра регулярно посещают специализированные ветеринарные конференции в качестве слушателей и спикеров и проводят вебинары для коллег и заводчиков!                         </p>
                        <p>
                        В числе наших услуг в области репродукции:</p>
                         <ul>
                            <li>•	Определение овуляции</li>
                            
                            <li>•	Определение сроков вязки</li>
                            
                            <li>•	Ведение беременности</li>
                            <li>•	Медикаментозное лечение пиометры</li>
                            <li>•	Эндоскопическое удаление кист яичников</li>
                            <li>•	Лечения бесплодия</li>
                            <li>•	Искусственное осеменение</li>
                            <li>•	Спермограмма </li>
