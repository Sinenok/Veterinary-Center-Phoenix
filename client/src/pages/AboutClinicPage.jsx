        ...
        <div className="about-body">
          ...
          <div className="about-body__wraper">
            ...
            <div className="purchase about-body__content">
              <div className="purchase-row-one">
                <div className="purchase__item about-clinic-text">
                  ...
                  препараты для обработки и защиты от паразитов, а также
                  различные аксессуары и средства для ухода. Мы тщательно
                  подбираем продукты, уделяя особое внимание их качеству и
                  безопасности.
                </div>
              ...
              <div className="purchase-row-two">
                ...
                <div className="purchase__item about-clinic-text">
                  ...
                  такие как "Royal Canin", "Hill`s", "ProPlan". У нас
                  представлена широкая линейка как повседневных кормов, так и
                  лечебных ветеринарных диет. Также в нашем магазине
                  представлены различные товары для ухода за животными,
                  лакомства, ошейники, игрушки и многое другое. По вопросам
                  наличия того или иного товара, Вы можете позвонить по единому
                  телефону нашего Центра: &#40;812&#41; 965-34-50
                </div>
              </div>
            </div>
          </div>
